<script setup lang="ts">
    ...
    <template>
      ...
      >
        ...
        <div class="mt-6">
            <p class="text-[#DE774A] text-[24px] font-bold">Reset your password</p>
    ...
    export default {
      ...
      methods: {
        submit() {
          ...
          AccountsService.forgotPassWord({email: this.email})
            .then(() => {
              this.confirmEmail();
      ...
      props: ['showForgotModal', 'close', 'confirmEmail', 'forgotPassword']
    };
    </script>
